...
import song from "@assets/dallas.mp3";
import "./LegalPage.scss";

const LegalPage = () => {
  return (
    <div className="legal-container">
      <audio src={song} type="audio/mp3" autoPlay>
        <track default Kind="captions" />
        Désolé, audio inactif
      </audio>
      <Link to="/">
        <div className="page-container">
          <div className="identite-container">
            ...
            <ul>
              ...
              <li>
                Propriétaire, animation, conception et réalisation : Uriel
                Sautron, Yohan Durand, Olivier Terral, Eric Vieira
              </li>
          ...
          <div className="interactivite-container">
            ...
            <p>
              ...
              apparaissant sur le site dans des espaces dédiés (notamment via
              les commentaires). Le contenu déposé reste sous la responsabilité
              de leurs auteurs, qui en assument pleinement l’entière
              responsabilité juridique. <br />
              <br />
          ...
          <div className="propriete-container">
            ...
            <p>
              ...
              écrite préalable de l’auteur.23 <br />
              <br />
          ...
          <div className="mentions-container">
            <p>
              Mentions légales fournies par WebExpress – Version 1.7 –
              Utilisation libre sous Licence Creative Commons CC BY-NC-ND 3.0 FR
              / creativecommons.org.
            </p>
            ...
            <ol>
              ...
              <li>
                Loi n° 78-87 du 6 janvier 1978, modifiée par la loi n° 2004-801
                du 6 août 2004, relative à l’informatique, aux fichiers et aux
                libertés
              </li>
              <li>
                Articles 38 et suivants de la loi 78-17 du 6 janvier 1978
              ...
              <li>
                Article 6 de la loi n° 2004-575 du 21 juin 2004 pour la
